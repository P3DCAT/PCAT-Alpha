...
namespace PCATApp {
    ...
    public partial class PCAT_PanelWindow : Form {
        ...
        private void OpenLabel_Click(object sender, EventArgs e) {
            if (CP_FileTreeView_LoadedFiles.SelectedNode != null) {
                Process.Start(CP_FileTreeView_LoadedFiles.SelectedNode.Name);
            }
        }

        private void RemoveLabel_Click(object sender, EventArgs e) {
            if (CP_FileTreeView_LoadedFiles.SelectedNode != null) {
                CP_FileTreeView_LoadedFiles.SelectedNode.Remove();
            }
        }
        ...
        */
        ...
        private void fileFolderToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog()) {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK) {
                    ...
                    CP_PictureBox_BaseContentViewer.Image = fs;
                    TT_PictureBox_ColorChannel.Image = fs;
                }
            }
        }
        private void Form1_Load(object sender, EventArgs e) {
            CP_Label_BuildingIndex.Hide();

            mainFileView = new MainFileView(this, CP_FileTreeView_LoadedFiles, CP_Button_LaunchPview_BaseContent, CP_PictureBox_BaseContentViewer, true);
            associatedFileView = new MainFileView(this, CP_FileTreeView_AssociatedFiles, CP_Button_LaunchPview_AssociatedContent, CP_PictureBox_AssociatedContentViewer, false);
        ...
        private void UpdateTextureMap() {
            ...
            List<string> unindexedModels = profile.GetUnindexedFilenames(CP_FileTreeView_LoadedFiles.Nodes);
        ...
        public void LoadProfile(Profile profile) {
            ...
            Utils.PopulateTreeView(CP_FileTreeView_LoadedFiles, profile.baseContent, '\\');
            Utils.PopulateTreeView(TT_TreeView_Textures, profile.baseContent, '\\');
            foreach (string filename in profile.baseContent)
            {
        ...
        private void associatedFilePviewButton_Click(object sender, EventArgs e)
        {
